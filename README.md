...
요구사항번호	B-17 스터디 룸 관리 기능	작성일	2024-08-20
요구사항명	스터디룸 예약에 관한 관리 기능을 제공한다.	작성자	임호균
DML
1.	스터디 룸 사용 내역을 등록, 수정, 삭제, 조회 할 수 있다.
2.	스터디 룸 사용 내역에 교육생의 이름, 과정명을 조회한다.
3.	스터디 룸의 정보는 강의실과 동일하며 이는 아래와 같다.
a.	스터디 룸 이름
b.	스터디 룸 최대 수용 인원 
4.	관리자는 스터디 룸 예약 정보를 관리한다.
출력되는 예약 정보는 아래와 같다.
a.	강의실 번호 (스터디룸 번호)
b.	대여 신청일
c.	대여 신청 시각
